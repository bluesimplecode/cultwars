...
| Screenreader-Grundgerüst (Stufe 1): aria-live-Region für Toasts + Zugwechsel, Sammlung/Kodex-Karten und Filter als fokussierbare Buttons mit Labels, Figuren-Modal als Dialog mit Fokusfalle, Escape und Fokus-Rückgabe | ✅ |
| Screenreader Stufe 2: Spielbrett + Platzierung per Tastatur — Zellen als Buttons mit Status-Labels, Pfeiltasten-Navigation (rovender Tabindex), Fokus-Erhalt über Brett-Neuaufbauten, Zug-/Platzierungs-Ansagen über die Live-Region. Offen: TalkBack-Test auf echtem Gerät | ✅ |
...
- [x] Screenreader Stufe 2: Spielbrett + Platzierungsphase per Tastatur bedienbar — Zellen sind fokussierbare Buttons mit Labels (Koordinate, Figur, Besitzer, Zug-/Schlag-/Bedroht-Status), Pfeiltasten-Navigation mit rovendem Tabindex, Fokus bleibt beim Brett-Neuaufbau auf derselben Zelle, jeder Zug und jede Platzierung wird über die Live-Region angesagt
- [ ] Screenreader-Test mit TalkBack auf echtem Android-Gerät (Stufe 1+2 sind nur per Code/Headless verifiziert)
